[navdeepproject14nov2-11f8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [navdeepproject14nov2-11f8] container is NOT running**.

.. tip::
   You must have your [navdeepproject14nov2-11f8] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35119  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='turanavdeep'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   navdeeptura/navdeepproject14nov2-11f8-amd64 (https://hub.docker.com/r/navdeeptura/navdeepproject14nov2-11f8-amd64)
...
.. code-block::
   ...
   docker run -d -p 39315:39315 -p 50481:50481 -p 33801:33801 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=navdeepproject14nov2-11f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8 \-\-env GITUSERNAME=navdeeptura  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi \-\-env SOLUTIONEXTERNALPORT=39315  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=50481  \-\-env SOLUTIONVIPERVIZPORT=33801 \-\-env DOCKERUSERNAME='navdeeptura' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=35119 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='turanavdeep' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  navdeeptura/navdeepproject14nov2-11f8-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - navdeeptura/navdeepproject14nov2-11f8-amd64
...
[navdeepproject14nov2-11f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/navdeeptura/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/navdeepproject14nov2-11f8
...
.. important::
   https://navdeepproject14nov2-11f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39315, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39615, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34705, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40851, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35975, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38513, HPDEHOST=127.0.1.1, HPDEPORT=35113, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35033

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3587-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, python-preprocess-9380-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, python-ai-381-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
