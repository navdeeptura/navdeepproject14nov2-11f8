...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41773  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='turanavdeep'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 54391:54391 -p 53183:53183 -p 34339:34339 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=navdeepproject14nov2-11f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8 \-\-env GITUSERNAME=navdeeptura  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi \-\-env SOLUTIONEXTERNALPORT=54391  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53183  \-\-env SOLUTIONVIPERVIZPORT=34339 \-\-env DOCKERUSERNAME='navdeeptura' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=41773 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='turanavdeep' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  navdeeptura/navdeepproject14nov2-11f8-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=54391, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42249, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37043, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40685, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37177, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34193, HPDEHOST=127.0.1.1, HPDEPORT=39205, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40135

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5938-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, python-preprocess-6382-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, python-ai-696-navdeepproject14nov2-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov2-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
